    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[60%] lg:w-[40%] lg:ml-20">
          <form>
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-sm">
                <p className="mb-6">Don't have an Account?
                  ...
                  transition duration-200 ease-in-out ml-1" to='/register'>Create Account</Link>
                </p>
                <p>
                  <Link className="text-blue-600 hover:text-blue-700
                  transition duration-200 ease-in-out" to='/forgot-password'>Forgot Password?</Link>
                </p>
            </div>
          ...
          transition duration-150 ease-in-out hover:shadow-lg active:bg-lime-900" type="submit">Sign in</button>
