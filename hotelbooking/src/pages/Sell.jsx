        ...
        <div className="flex">
          <button
            ...
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase 
                ...
                ${type === "rent" ? "bg-lime-700" : "bg-red-600"}`}
          >
            Sell
          </button>
          ...
          <button
            ...
            className={`ml-3 px-7 py-3 font-medium text-sm uppercase 
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${type === "sale" ? "bg-lime-700" : "bg-red-600"}`}
          >
            Rent
          </button>
        </div>
        ...
        <div className="flex">
          <button
            ...
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase 
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${!parking ? "bg-lime-700" : "bg-red-600"}`}
          >
            Yes
          </button>
        ...
        <div className="flex">
          <button
            ...
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase 
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${!furnished ? "bg-lime-700" : "bg-red-600"}`}
          >
            Yes
          </button>
            ...
            <div className="">
              ...
              <input
                ...
                className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition
                    duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-slate-600
                    text-center"
              />
            </div>
