...
export default function Sell() {
  ...
  return (
    <main className='max-w-md px-2 mx-auto'>
        <h1 className='text-3xl text-center mt-6 font-bold'>Start selling today</h1>
        <form>
            <p className='text-lg mt-6 font-semibold'>Sell / Rent</p>
            <div className='flex'>
                <button type='button' id='type' value='sale'
                onClick={onChange} className={`mr-3 px-7 py-3 font-medium text-sm uppercase 
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${type === 'rent' ? 'bg-lime-700' : 'bg-red-600'}`}>Sell</button>

            <button type='button' id='type' value='sale'
                onClick={onChange} className={`ml-3 px-7 py-3 font-medium text-sm uppercase 
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${type === 'sale' ? 'bg-lime-700' : 'bg-red-600'}`}>Rent</button>
            </div>
            <p className='text-lg mt-6 font-semibold'>Name(*)</p>
        <input type='text' id='name' value={name} onChange={onChange} placeholder='Name' maxLength={64} minLength="10"
            required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded
        ...
        <div className='flex space-x-6 mb-6'>
            <div>
                ...
                <input type='number' id='bedrooms' value={bedrooms} onChange={onChange} min='1' max='50' required
                    className='w-full px-4 py-2 text-xl text-gray700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700
        ...
        <p className='text-lg mt-6 font-semibold'>Parking spot</p>
            <div className='flex'>
                ...
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${!parking ? 'bg-lime-700' : 'bg-red-600'}`}>Yes</button>

            <button type='button' id='parking' value={false}
                onClick={onChange} className={`ml-3 px-7 py-3 font-medium text-sm uppercase 
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${parking ? 'bg-lime-700' : 'bg-red-600'}`}>No</button>
            </div>
            ...
            <div className='flex'>
                ...
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${!furnished ? 'bg-lime-700' : 'bg-red-600'}`}>Yes</button>

            <button type='button' id='furnished' value={false}
                onClick={onChange} className={`ml-3 px-7 py-3 font-medium text-sm uppercase 
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${furnished ? 'bg-lime-700' : 'bg-red-600'}`}>No</button>
            </div>
        ...
        <p className='text-lg font-semibold'>Offer</p>
            <div className='flex mb-6'>
                ...
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${!offer ? 'bg-lime-700' : 'bg-red-600'}`}>Yes</button>

            <button type='button' id='offer' value={false}
                onClick={onChange} className={`ml-3 px-7 py-3 font-medium text-sm uppercase 
                shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg 
                translate duration-150 ease-in-out w-full 
                ${offer ? 'bg-lime-700' : 'bg-red-600'}`}>No</button>
            </div>
            <div className='flex items-center mb-6'>
                <div className=''>
                    <p className='text-lg font-semibold'>Digital List Price (*)</p>
                    <div className='flex w-full justify-center items-center space-x-6'>
                        <input type='number' id='price' value={price} onChange={onChange} min="50" max="9999999" required
            ...
            {offer && (
                ...
                <div className=''>
                    ...
                    <div className='flex w-full justify-center items-center space-x-6'>
                        <input type='number' id='discountedPrice' value={discountedPrice} onChange={onChange} min="50" max="9999999"
                         required={offer}
                            className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition
                            duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'
                        />
            ...
            <button type='submit' className='mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded
