    ...
    <div>
        <main>
            ...
            {shareLinkCopy && (
                ...
                rounded-md bg-white z-10 p-2'>Link Copied</p>
            )}
            <div className='m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg
            bg-white lg:space-x-5 z-10 overflow-x-hidden'>
                <div className='w-full h-[200px] lg-[400px]'>
                    <p className='text-2xl font-bold mb-3 text-blue-900'>{listing.name} - $ {listing.offer ? listing.discountedPrice.toString()
          .replace(/\B(?=(\d{3})+(?!\d))/g, ",") :
          ...
          <div className='flex justify-start items-center space-x-4 w-[75%]'>
            ...
            {listing.offer && (
                ...
                bg-green-800 rounded-md p-1 text-white text-center font-semibold shadow-md'>${+listing.price - +listing.discountedPrice} discount</p>
            )}
          </div>
